...
export const mockJurados: Jurado[] = [
  { id: "c0000001-0000-4000-8000-000000000001", concursoId: MOCK_CONCURSO_ID, nombre: "Municipalidad Carmen de la Legua", userId: null, activo: true },
  { id: "c0000001-0000-4000-8000-000000000002", concursoId: MOCK_CONCURSO_ID, nombre: "Ministerio de Cultura", userId: null, activo: true },
  { id: "c0000001-0000-4000-8000-000000000003", concursoId: MOCK_CONCURSO_ID, nombre: "Tuna UNAC - Marco Perez", userId: null, activo: true },
  { id: "c0000001-0000-4000-8000-000000000004", concursoId: MOCK_CONCURSO_ID, nombre: "Tuna UNAC - Henry Lopez", userId: null, activo: true },
];

export const mockCategorias: Categoria[] = [
  { id: "d0000001-0000-4000-8000-000000000001", concursoId: MOCK_CONCURSO_ID, nombre: "Mejor Instrumental", descripcion: "Evalúa la ejecución musical centrada en calidad y coordinación de instrumentos.", pesoTotal: 0.2, orden: 1 },
  { id: "d0000001-0000-4000-8000-000000000002", concursoId: MOCK_CONCURSO_ID, nombre: "Mejor Solista", descripcion: "Evalúa la actuación del solista vocal.", pesoTotal: 0.2, orden: 2 },
  { id: "d0000001-0000-4000-8000-000000000003", concursoId: MOCK_CONCURSO_ID, nombre: "Mejor Pandereta", descripcion: "Evalúa el manejo de la pandereta.", pesoTotal: 0.2, orden: 3 },
  { id: "d0000001-0000-4000-8000-000000000004", concursoId: MOCK_CONCURSO_ID, nombre: "Mejor Bandera", descripcion: "Evalúa el manejo de la bandera.", pesoTotal: 0.2, orden: 4 },
  { id: "d0000001-0000-4000-8000-000000000005", concursoId: MOCK_CONCURSO_ID, nombre: "Mejor Capa", descripcion: "Evalúa la ejecución con capa.", pesoTotal: 0.2, orden: 5 },
];
